...
| Screen VLM — Holo2-4B<br>[`VLChat`](Examples/VLChat) | Repo agent — FastContext-4B<br>[zoo `CoreAIChat`](https://github.com/john-rocky/coreai-model-zoo/tree/main/apps/CoreAIChat) | Segmentation — SAM 3<br>[zoo](https://github.com/john-rocky/coreai-model-zoo) |
| <img src="https://raw.githubusercontent.com/john-rocky/coreai-assets/main/kit/depth-da3.jpg" alt="Depth estimation" width="250"> | <img src="https://raw.githubusercontent.com/john-rocky/coreai-assets/main/kit/sr-adcsr.jpg" alt="Super-resolution" width="250"> | <img src="https://raw.githubusercontent.com/john-rocky/coreai-assets/main/kit/pii-gliner2.jpg" alt="PII redaction" width="250"> |
| Depth — Depth Anything 3<br>[`DepthCamera`](Examples/DepthCamera) | 4× super-res — AdcSR<br>[`UpscaleDemo`](Examples/UpscaleDemo) | PII redaction — GLiNER2<br>[`InfoExtract`](Examples/InfoExtract) |
